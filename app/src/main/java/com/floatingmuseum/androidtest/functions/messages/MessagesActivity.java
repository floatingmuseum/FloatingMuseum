package com.floatingmuseum.androidtest.functions.messages;
...
public class MessagesActivity extends BaseActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
        ...
        public void onResult(@NonNull Status status) {
            if (status.isSuccess()) {
                ...
                if (status.hasResolution()) {
                    if (!mResolvingError) {
                        try {
                            status.startResolutionForResult(MessagesActivity.this,
